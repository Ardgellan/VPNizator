...
class SubscriptionChecker:
    def __init__(self):
        ...
        self._scheduler.add_job(self._check_subscriptions, "cron", hour=16, minute=48)
    ...
    async def _check_subscriptions(self):
        ...
        if last_day_users:
            await self._find_and_notify_users_with_last_day_left_subscription(users_ids=last_day_users)
