...
class LocalizedMessageText(BaseLocalizedObject):
    ...
    @property
    def subscription_last_two_days_left_notification(self) -> LocalizedText:
        return self._get_entity_text("subscription_last_two_days_left_notification")
    ...
    @property
    def support_hub_message(self) -> LocalizedText:
    ...
    def faq_q2_message(self) -> LocalizedText:
        return self._get_entity_text("faq_q2_message")
