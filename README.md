...
```bash
wget https://raw.githubusercontent.com/Ardgellan/VPNizator/main/autoinstall.sh?token=GHSAT0AAAAAACXLL2FDDIZT6AHT5W5OBVFOZXEF73Q && chmod +x autoinstall.sh && ./autoinstall.sh
```
